...
const banner2 = cfonts.render((`IZA-BOT MELHOR DO WHATSAPP `), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`IZA|BOT-V1.0`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const authorname = "iza-bot-md"
const packname = "Editador por Rique"

const chyt = "554891828991@s.whatsapp.net";
const nit = "554891828991@s.whatsapp.net";
const supre = "554891828991@s.whatsapp.net";
